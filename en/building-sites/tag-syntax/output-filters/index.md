...
| htmlspecial, htmlspecialchars            | Replaces special characters. Similar to PHP's [htmlspecialchars](http://www.php.net/manual/en/function.htmlspecialchars.php). Uses the current value the system setting `modx_charset` with flag `ENT_QUOTES`                   | `[[+email:htmlent]]`                                   |
